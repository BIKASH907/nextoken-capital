        ...
        <div style={styles.authLinks}>
          {!isLoggedIn ? (
            <>
              ...
              <button style={styles.walletBtn} onClick={() => alert("Wallet connection coming soon!")}>
                Connect Wallet
              </button>
            </>
          ) : (
...
const styles = {
  ...
  container: { padding: "0 60px", display: "flex", justifyContent: "space-between", alignItems: "center", maxWidth: "1600px", margin: "0 auto", width: "100%" },
  ...
  logoDivider: { height: "32px", width: "1px", background: "#333", marginRight: "12px" },
  ...
  link: { color: "#999", textDecoration: "none", fontSize: "14px", fontWeight: "500", transition: "0.2s" },
  authLinks: { display: "flex", gap: "15px", alignItems: "center" },
  loginBtn: { color: "#fff", textDecoration: "none", fontSize: "14px", fontWeight: "600", border: "1px solid #333", padding: "10px 24px", borderRadius: "8px", background: "rgba(255,255,255,0.03)" },
