...
fs.mkdirSync("app/register", { recursive: true });
...
fs.writeFileSync("app/register/page.tsx", code, "utf8");
console.log("✅ app/register/page.tsx written successfully!");
console.log("📏 Size: " + code.length + " characters");
console.log("🎨 Uses inline styles — works without Tailwind");
console.log("🔒 Step validation — next step locked until current step complete");
console.log("🚫 KYC restriction — logged-in users without KYC cannot invest");