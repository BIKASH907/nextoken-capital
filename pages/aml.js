...
const SECTIONS = [
  ...
  { id:"8", title:"Record Keeping", content:"We retain KYC and AML records for a minimum of 5 years after the end of the business relationship, in compliance with EU AML Directives. Records are stored securely and accessed only by authorized compliance personnel." },
      ...
      <div className="lp">
        <div className="lp-hero">
          <div className="lp-hero-inner">
            ...
            <p className="lp-meta">Last updated: March 1, 2026 · Nextoken Capital UAB · FATF Aligned · Bank of Lithuania Supervised</p>
          </div>
        </div>
