...
const articles = [
  ...
  },
  {
    ...
    desc:"The Markets in Crypto-Assets regulation is the EU's landmark crypto law. Learn what it means for buyers, issuers, and platforms like Nextoken.",
...
const glossary = [
  ...
  { term:"ERC-3643",   def:"The institutional-grade asset token standard on Ethereum. Enforces KYC/AML compliance at the smart contract level." },
  ...
  { term:"Whitelist",  def:"A list of verified wallet addresses permitted to hold or transfer a asset token under ERC-3643." },
    ...
    <div style={S.page}>
      ...
      <div style={S.sec}>
        ...
        {[
          ...
          { q:"Can I lose my entire investment?",                             a:"Yes — all investments carry risk including the potential loss of capital. Tokenized assets carry risk. We provide risk ratings (Low / Medium / High) for every listing and encourage investors to diversify and only invest what they can afford to lose." },
          { q:"How do I receive returns on my investment?",                   a:"Returns vary by asset type. Bonds pay regular interest (yield) directly to your wallet or bank account. Equity tokens may pay earnings distributions or appreciate in value. Real estate tokens distribute rental income on a scheduled basis. All distributions are automated via smart contracts." },
          { q:"Can I sell my tokens before maturity?",                        a:"Yes, for eligible tokens listed on the Nextoken Exchange. The secondary market allows peer-to-peer token trading among verified buyers. Not all tokens are listed on the exchange — check each offering's terms for secondary market eligibility." },
