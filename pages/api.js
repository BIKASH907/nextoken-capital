    ...
    <>
      ...
      <div style={s.page}><div style={s.wrap}>
        ...
        <div style={{ background: "rgba(240,185,11,0.06)", border: "1px solid rgba(240,185,11,0.2)", borderRadius: 14, padding: "32px", textAlign: "center", marginTop: 48 }}>
          ...
          <div style={{ fontSize: 13, color: "rgba(255,255,255,0.5)", marginBottom: 24 }}>API access is available to verified platform users.</div>
          <a href="/contact" style={{ display: "inline-block", background: "#f0b90b", color: "#0B0E11", fontWeight: 800, padding: "12px 28px", borderRadius: 10, textDecoration: "none", fontSize: 14 }}>Request API Key</a>
        </div>
      </div></div>
    </>
  );
