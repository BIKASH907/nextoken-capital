...
const FEES = [
  ...
  { icon:'🔗', title:'Token Purchase', fee:'0.2%', color:'#F0B90B', desc:'A small fee applied when you purchase any tokenized asset on the marketplace.', detail:'Example: If you purchase EUR 1,000 of a real estate token, the fee is EUR 2.00. This fee is deducted automatically via smart contract at the time of purchase.', example:'EUR 1,000 purchase → EUR 2.00 fee' },
  ...
  { icon:'📤', title:'Fiat Conversion', fee:'0.3%', color:'#F0B90B', desc:'Fee when converting tokens back to fiat currency.', detail:'Minimum fee: EUR 2.00. Maximum fee: EUR 50.00. Example: Withdrawing EUR 1,000 costs EUR 3.00.', example:'EUR 1,000 conversion → EUR 3.00 fee' },
  { icon:'💸', title:'Estimated Earnings', fee:'Free', color:'#0ECB81', desc:'Receive asset returns, and earnings payments with no deduction.', detail:'All returns are paid directly to your connected wallet. No platform fee is applied to incoming earnings distributions.' },
  { icon:'🪪', title:'KYC Verification', fee:'Free', color:'#0ECB81', desc:'Full identity verification powered by Sumsub — required to purchase.', detail:'KYC is free for all buyers. Enhanced due diligence for high-value buyers is also provided at no cost.' },
  { icon:'📄', title:'Documents & Reports', fee:'Free', color:'#0ECB81', desc:'Download purchase contracts, statements, and tax reports anytime.', detail:'All legal documents, transaction history, annual statements, and tax reports are available for free download.' },
];
const EXAMPLES = [
  ...
  {tx:'Fiat Conversion',amt:'EUR 500',rate:'0.3%',pay:'EUR 2.00 (min)'},
  {tx:'Fiat Conversion',amt:'EUR 2,000',rate:'0.3%',pay:'EUR 6.00'},
