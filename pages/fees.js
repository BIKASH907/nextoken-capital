...
const FEES = [
  ...
  { icon:'💸', title:'Estimated Earnings', fee:'Free', color:'#0ECB81', desc:'Receive investment returns, dividends, and earnings payments with no deduction.', detail:'All returns are paid directly to your account balance. No platform fee is applied to incoming earnings distributions.' },
