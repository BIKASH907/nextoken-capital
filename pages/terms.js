...
const SECTIONS = [
  ...
  { id:"3", title:"Regulated Services", content:"Nextoken Capital UAB is registered as an technology marketplace company by the Lithuanian authorities and holds a MiCA marketplace registration. All services provided through the platform are subject to applicable EU financial regulation, including the Markets in Crypto-Assets Regulation (MiCA) and the EU DLT Pilot Regime." },
  ...
  { id:"6", title:"Trading Rules", content:"All trades executed on the platform are final and cannot be reversed. You are solely responsible for your trading decisions. Nextoken Capital UAB operates as a technology marketplace connecting asset issuers with investors. The platform charges a 0.2% commission on primary investments, paid from the transaction via smart contract. Nextoken Capital does not hold, custody, or transmit investor funds. All transactions are executed directly between investor wallets and issuer wallets via audited smart contracts on Polygon blockchain. Additional fees may apply for asset issuance and withdrawal. Fee schedules are published on the platform and may be updated with 30 days notice." },
