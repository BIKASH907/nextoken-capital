    ...
    <>
      ...
      <main className="home-page">
        ...
        <section className="hero">
          <div className="container">
              ...
              <div className="heroInner">
                <div className="heroContent">
                  ...
                  <div className="heroActions">
                    ...
                    <button className="btnSecondary" onClick={scrollToHowItWorks}>
                      How it Works ↓
                    </button>
                  </div>
                </div>
            ...
            {/* HOW IT WORKS */}
            <div ref={howItWorksRef} className="sectionTitle" style={{ marginTop: 36 }}>
              HOW IT WORKS
            </div>
            ...
            <section className="ctaBanner">
              <div className="ctaContent">
                ...
                <p>
                  ...
                  Access tokenized assets across bonds, equity, and more.
                </p>
                <button
            ...
            <footer className="footer">
              ...
              <div className="disclaimer">
                ...
                not guarantees. Always do your own research and comply with your local laws.
      ...
      <style jsx>{`
        ...
        .sparkle {
          ...
          pointer-events: none;
          opacity: 0.18;
          background-image: radial-gradient(2px 2px at 10% 20%, #fff, transparent 60%),
        ...
        .heroCard {
          ...
          background: radial-gradient(900px 350px at 70% 40%, rgba(255,193,90,0.18), transparent 60%),
            radial-gradient(900px 350px at 30% 40%, rgba(58,160,255,0.14), transparent 60%),
        ...
        .heroVisual {
          ...
          border-radius: 22px;
          border: 1px solid rgba(255,255,255,0.12);
          background: radial-gradient(120px 120px at 75% 30%, rgba(255,255,255,0.22), transparent 60%),
            radial-gradient(260px 260px at 40% 70%, rgba(255,193,90,0.25), transparent 62%),
            radial-gradient(220px 220px at 70% 80%, rgba(58,160,255,0.22), transparent 60%),
        ...
        .coin {
          ...
          right: 20px; top: 18px;
          border-radius: 999px;
          background: radial-gradient(70px 70px at 30% 30%, rgba(255,255,255,0.35), transparent 55%),
            linear-gradient(135deg, #ffda7a, #b97b23);
          box-shadow: 0 30px 80px rgba(255,193,90,0.3);
          display: grid; place-items: center;
          border: 1px solid rgba(255,255,255,0.18);
          color: #1a1206; font-weight: 900; font-size: 38px;
        }
        ...
        .chartLabel { position: absolute; top: 10px; left: 12px; font-size: 10px; color: rgba(255,218,122,0.7); font-weight: 600; }
        ...
        .chip {
          ...
          width: 120px; height: 60px; border-radius: 16px;
          background: linear-gradient(135deg, rgba(58,160,255,0.3), rgba(255,193,90,0.18));
          border: 1px solid rgba(255,255,255,0.14);
        ...
        .vmCard {
          ...
          border-radius: 18px; padding: 20px; box-shadow: 0 18px 40px rgba(0,0,0,0.35);
        }
        ...
        .featureCard {
          ...
          background: radial-gradient(240px 140px at 30% 20%, rgba(255,193,90,0.16), transparent 60%),
            linear-gradient(180deg, rgba(255,255,255,0.05), rgba(255,255,255,0.03));
          box-shadow: 0 18px 40px rgba(0,0,0,0.35); padding: 18px 16px;
        }
        ...
        .tokenSection {
          margin-top: 18px; border-radius: 26px; border: 1px solid rgba(255,255,255,0.14);
          background: radial-gradient(900px 250px at 50% 20%, rgba(255,193,90,0.2), transparent 60%),
            radial-gradient(900px 280px at 20% 80%, rgba(58,160,255,0.14), transparent 60%),
        ...
        .tokenCard {
          ...
          box-shadow: 0 16px 40px rgba(0,0,0,0.3); display: flex; gap: 12px; align-items: flex-start;
        }
        ...
        .newsTag {
          ...
          background: rgba(255,218,122,0.12); border: 1px solid rgba(255,218,122,0.2);
        ...
        .ctaBanner {
          ...
          background: radial-gradient(800px 300px at 50% 50%, rgba(255,193,90,0.22), transparent 60%),
            linear-gradient(180deg, rgba(255,255,255,0.05), rgba(255,255,255,0.02));
        ...
        .footerBrand p { font-size: 13.5px; color: rgba(238,241,255,0.6); line-height: 1.6; margin: 0; max-width: 240px; }
        ...
        .disclaimer { margin-top: 20px; font-size: 11.5px; color: rgba(238,241,255,0.45); line-height: 1.65; text-align: center; padding-bottom: 28px; }
