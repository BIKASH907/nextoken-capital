      ...
      <div className="rg">
        ...
        <div className="rg-wrap">
          ...
          <div className="rg-card">
            ...
            {/* STEP 0 — Account */}
            {step === 0 && <>
              <button onClick={() => window.location.href = "/api/auth/signin/google?callbackUrl=%2Fdashboard"} style={{width:"100%",padding:"12px",background:"#fff",color:"#000",border:"none",borderRadius:8,fontSize:14,fontWeight:700,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:10,marginBottom:20}}><img src="https://www.google.com/favicon.ico" width={18} height={18} alt="" />Continue with Google</button>
