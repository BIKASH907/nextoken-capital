    ...
    <div onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:10, padding:14, background:"rgba(255,255,255,0.025)", borderRadius:10, marginBottom:16 }}>
        {[["Yield",bond.yld],["Price","EUR "+bond.price],["Term",bond.term]].map(([l,v]) => (
          <div key={l}>
            <div style={{ fontFamily:"Syne,sans-serif", fontSize:17, fontWeight:700, color:"#F0B90B" }}>{v}</div>
      ...
      <div style={{ marginBottom:16 }}>
        <div style={{ display:"flex", justifyContent:"space-between", fontSize:12, color:"#7a7a96", marginBottom:6 }}>
          <span>Funding {bond.progress}%</span>
    ...
    <div style={S.page}>
      ...
      <div style={S.sec}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))", gap:16 }}>
          {[
            ...
            { icon:"🔄", name:"Convertible Notes", color:"#F0B90B", desc:"Blend debt yield with future equity conversion logic for growth-stage issuers." },
      ...
      <div id="issue" style={S.sec}>
        ...
        <div style={{ position:"relative", display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(180px,1fr))", gap:32 }}>
          ...
          {[
            { n:"01", t:"Submit Bond Structure", b:"Define size, maturity, yield, investor profile, and offering goals." },
            { n:"02", t:"Review Documentation",  b:"Prepare issuer data, legal structure, financials, and disclosure package." },
            { n:"03", t:"Launch Fundraise",      b:"Open the offering to eligible investors through a digital bond issuance workflow." },
            { n:"04", t:"Track Progress",        b:"Monitor subscriptions, allocation progress, and fundraising milestones in real time." },
            { n:"05", t:"Secondary Market",      b:"Move eligible instruments toward digital exchange visibility and liquidity workflows." },
          ].map((s) => (
            <div key={s.n}>
